const common = {
    ...
    "shop.item.darkTerminal.description":
        "Ein elegantes dunkles Terminal-Design mit blauen Akzenten - klassisch und professionell",
    "shop.item.matrixTerminal.name": "Matrix Terminal-Design",
    "shop.item.matrixTerminal.description":
        "Grün-auf-schwarz Terminal-Design wie in den Matrix-Filmen - für das ultimative Hacker-Gefühl",
    "shop.item.goldenTerminal.name": "Goldenes Terminal-Design",
    "shop.item.goldenTerminal.description":
        "Ein glänzendes goldenes Terminal-Design, das allen deine Git-Meisterschaft zeigt",
    "shop.item.gitMascot.name": "Git Maskottchen-Haustier",
    "shop.item.gitMascot.description":
        "Ein niedliches animiertes Maskottchen, das dich bei schwierigen Levels anfeuert",
    "shop.item.victorySound.name": "Siegessound-Paket",
    "shop.item.victorySound.description":
        "Befriedigende Soundeffekte beim Abschließen von Levels und Lösen von Herausforderungen",
    ...
    "shop.item.emojiCommits.description":
        "Füge lustige Emoji-Vorschläge zu deinen Commit-Nachrichten hinzu für bessere Git-Historie",
    ...
    "shop.item.gitLegend.description":
        "Exklusives Abzeichen, das zeigt, dass du fortgeschrittene Git-Befehle gemeistert hast",
    ...
    "account.copyPassword": "Passwort kopieren",
    "account.passwordCopied": "Passwort kopiert",
