const levels = {
    // Level Page
    "level.gitTerminal": "Git टर्मिनल",
    "level.currentChallenge": "मौजूदा चुनौती",
    "level.objectives": "उद्देश्य:",
    "level.showHints": "संकेत दिखाएं",
    "level.hideHints": "संकेत छुपाएं",
    "level.nextLevel": "अगला स्तर",
    "level.filesToEdit": "एडिट करने के लिए फ़ाइलें:",
    "level.workingTreeClean": "वर्किंग ट्री साफ़ है",
    ...
    "level.advancedOptions": "एडवांस्ड विकल्प",
    "level.hideAdvancedOptions": "एडवांस्ड विकल्प छुपाएं",
    "level.resetLevel": "स्तर रीसेट करें",
    "level.resetAllProgress": "पूरी प्रगति रीसेट करें",
    "level.resetConfirm": "क्या आप वाकई अपनी पूरी प्रगति रीसेट करना चाहते हैं?",
    "level.resetOptions": "रीसेट विकल्प",
    "level.resetDescription": "चुनें कि आप क्या रीसेट करना चाहते हैं:",
    "level.resetAllConfirm": "क्या आप वाकई अपनी पूरी (ALL) प्रगति रीसेट करना चाहते हैं? इसे वापस नहीं लिया जा सकता!",
    "level.level": "स्तर",
    "level.levelCompleted": "स्तर पूरा हुआ!",
    "level.realWorldContext": "असल दुनिया का संदर्भ",
    "level.task": "आपका काम",
    "level.startCoding": "कोडिंग शुरू करें",
    "level.storyButton": "कहानी दिखाएं",
    "level.advancedModeOn": "एडवांस्ड मोड (चालू)",
    "level.advancedModeOff": "एडवांस्ड मोड (बंद)",
    "level.notFound": "स्तर नहीं मिला",
    "level.techModeOn": "कमांड पर फ़ोकस करें (टेक मोड)",
    "level.storyModeOn": "कहानी का संदर्भ दिखाएं (स्टोरी मोड)",
    "level.techModeDescription":
        "टेक मोड तेज़, सीधे अनुभव के लिए बिना कहानी या संदर्भ के सिर्फ़ Git कमांड पर फ़ोकस करता है।",
    "level.storyModeDescription":
        "स्टोरी मोड यह समझने में मदद के लिए असल दुनिया का संदर्भ और स्पष्टीकरण देता है कि Git कमांड क्यों और कैसे उपयोग किए जाते हैं।",
    "level.editFile": "फ़ाइल एडिट करें",
    "level.deleteFile": "फ़ाइल डिलीट करें",
    "level.confirmDelete": "क्या आप वाकई {file} को डिलीट करना चाहते हैं?",
    "level.hints": "संकेत",
    ...
    "intro.level1.hint2":
        "यह एक छिपा हुआ .git फ़ोल्डर बनाता है — वही फ़ोल्डर *ही* रिपॉजिटरी है, जहाँ Git हर वर्ज़न रखता है",
    ...
    "intro.level1.story.narrative":
        "TechStart में एक डेवलपर के रूप में आपकी नई नौकरी में आपका स्वागत है! मैं Alex हूं, आपका टीम लीड।\n\nपहली कमांड टाइप करने से पहले: Git क्या है, और हर टीम इसे अपनाने पर ज़ोर क्यों देती है?\n\nसोचिए कि आज हम दोनों एक ही फ़ाइल में बदलाव कर रहे हैं। आप मुझे `login-final.js` भेजते हैं, मैं आपको `login-final-v2.js` लौटाता हूं, और शुक्रवार तक किसी को नहीं पता कि कौन सा वर्ज़न काम करता है — या सोमवार को वह फ़ाइल कैसी थी, जब वह काम कर रही थी।\n\nGit एक वर्जन कंट्रोल सिस्टम है और यह ठीक इसी समस्या को हल करता है। यह आपके प्रोजेक्ट का पूरा इतिहास रखता है: हर बदलाव, किसने किया, और किसी भी पुरानी स्थिति में वापस जाने का रास्ता। साथ ही यह कई लोगों को एक ही कोड पर काम करने देता है, बिना एक-दूसरे का काम मिटाए।\n\nGit उस इतिहास को एक रिपॉजिटरी में रखता है — आपका आम प्रोजेक्ट फ़ोल्डर, और उसके साथ एक छिपा हुआ `.git` फ़ोल्डर जिसमें हर वर्ज़न सुरक्षित रहता है। इसे बनाने के लिए एक ही कमांड चाहिए: `git init`।",
    "intro.level1.story.realWorldContext":
        'Git वर्जन कंट्रोल का मानक है: लगभग हर सॉफ़्टवेयर टीम इसका उपयोग करती है, और किसी नए प्रोजेक्ट में सबसे पहले यही टूल सेट अप किया जाता है। इसके बिना "यह किसने, कब और क्यों बदला?" का कोई जवाब नहीं होता।',
    ...
    "intro.level3.hint1":
        "`git clone` के बाद कोई असली पता लिखकर चलाएं, जैसे `git clone https://github.com/octocat/Hello-World.git`",
    "intro.level3.hint2": "क्लोन करने के बाद, रिपॉजिटरी फ़ोल्डर में जाने के लिए `cd` का उपयोग करें",
    "intro.level3.hint3":
        "यह https://github.com/user/repo.git जैसा कोई असली पता होना चाहिए — एंगल ब्रैकेट में लिखा प्लेसहोल्डर स्वीकार नहीं किया जाएगा",
    ...
    "files.level1.story.narrative":
        '"अरे!" आपकी सहकर्मी Sarah बुलाती हैं। "अब यह सीखने का समय है कि Git आपका काम असल में कैसे सहेजता है — क्योंकि फ़ाइल में बदलाव कर देना ही काफ़ी नहीं है।"\n\nवे व्हाइटबोर्ड पर तीन डिब्बे बनाती हैं:\n\n1. **आपका फ़ोल्डर** — जहाँ आप फ़ाइलें बदलते हैं। Git देखता रहता है, पर अपने आप कुछ सहेजता नहीं।\n2. **स्टेजिंग एरिया** — उन बदलावों की सूची जिन्हें आप अगली सहेजी गई स्थिति में शामिल करना चाहते हैं।\n3. **रिपॉजिटरी** — सहेजी गई हर चीज़ का स्थायी इतिहास।\n\n"कोई भी कमिट सिर्फ़ उतना ही दर्ज करता है जितना स्टेजिंग एरिया में होता है," वे कहती हैं। "इसीलिए कुछ बदलने के बाद आप सीधे कमिट नहीं कर सकते: Git यह नहीं मान लेता कि आपके सारे बदलाव एक साथ जुड़े हैं। यह आप तय करते हैं। `git add <file>` एक बदलाव को स्टेजिंग में डालता है, और `git add .` मौजूदा फ़ोल्डर की हर चीज़ ले लेता है।"',
    "files.level1.story.realWorldContext":
        "स्टेजिंग वह कदम है जिसे शुरुआती लोग छोड़ देते हैं और अनुभवी डेवलपर सोच-समझकर इस्तेमाल करते हैं। दो अलग-अलग चीज़ें ठीक कीं? उन्हें अलग-अलग स्टेज और कमिट करें — इससे इतिहास पढ़ने लायक बना रहता है, और बाद में हर बदलाव को अकेले पलटा जा सकता है।",
    ...
    "files.level2.story.narrative":
        '"बहुत बढ़िया!" आपकी प्रगति देखकर Alex कहते हैं। "आपके बदलाव स्टेज हो गए हैं। अब इन्हें स्थायी बना दें।"\n\nवे समझाते हैं: "`git commit` स्टेजिंग एरिया की हर चीज़ लेकर उसे एक स्नैपशॉट के रूप में इतिहास में लिख देता है — आपके नाम, समय और एक संदेश के साथ। इसके बाद स्टेजिंग एरिया फिर खाली हो जाता है, अगले सेट के लिए तैयार।"\n\n"दो बातें जानने लायक हैं। जब कुछ भी स्टेज न हो, तो कमिट करने से कुछ नहीं होता — Git बता देता है कि कमिट करने के लिए कुछ नहीं है, और इसका मतलब लगभग हमेशा यही होता है कि `git add` रह गया है। और संदेश कोई खानापूर्ति नहीं है: `-m "..."` ही वह तरीका है जिससे अगला व्यक्ति — यानी आमतौर पर तीन महीने बाद आप खुद — जान पाता है कि यह बदलाव क्यों मौजूद है।"',
...
अपनी महारत साबित करने के लिए तैयार हैं? घड़ी टिक-टिक कर रही है...`,
    ...
    "archaeology.level1.story.narrative":
        "वैलिडेशन कोड में एक गंभीर बग 23% यूरोपीय ग्राहकों को प्रभावित कर रहा है। यह कोड 18 महीनों में 4 अलग-अलग डेवलपरों ने लिखा था। आपके सीनियर डेवलपर समझाते हैं: 'कोड आर्कियोलॉजी में आपका स्वागत है! Git सिर्फ़ वर्जन कंट्रोल नहीं है - यह आपकी टाइम मशीन है। हर लाइन की एक कहानी है।' यह देखने के लिए `git blame src/utils/validator.js` से शुरुआत करें कि हर लाइन को आख़िरी बार किसने छुआ, फिर यह समझने के लिए कि कोड इस तरह क्यों लिखा गया, `git log --oneline` और `git show` का उपयोग करें।",
    "archaeology.level1.story.realWorldContext":
        "कई योगदानकर्ताओं वाले बड़े, लंबे समय से चल रहे कोडबेस को बनाए रखने के लिए कोड आर्कियोलॉजी का हुनर ज़रूरी है।",
    "archaeology.level1.story.taskIntroduction":
        "Git के फ़ॉरेंसिक टूल्स - git blame, git log, और git show - का उपयोग करके कोड इतिहास की जांच करना और बग का स्रोत खोजना सीखें।",

    "archaeology.level2.name": "Git Log के साथ कमिट फ़ॉरेंसिक्स",
    "archaeology.level2.description": "जटिल कोड इतिहास की जांच करने की एडवांस्ड तकनीकों में महारत हासिल करें",
    "archaeology.level2.objective1": "किसी कीवर्ड के लिए कमिट संदेशों में खोजने के लिए git log --grep का उपयोग करें",
    ...
    "archaeology.level2.story.title": "सुरक्षा ऑडिट ट्रेल",
    "archaeology.level2.story.narrative":
        "आपकी कंपनी को एक सुरक्षा ऑडिट मिला। ऑडिटर सभी सुरक्षा-संबंधी बदलावों का पूरा इतिहास चाहते हैं: ऑथेंटिकेशन, पासवर्ड हैंडलिंग, एन्क्रिप्शन। कोडबेस में 3 सालों में 2,847 कमिट हैं। आपके सिक्योरिटी लीड Git की खोज क्षमताएं समझाते हैं: संदेशों के लिए --grep, कोड कंटेंट के लिए -S, योगदानकर्ताओं के लिए --author। एडवांस्ड git log तकनीकों का उपयोग करके एक व्यापक ऑडिट ट्रेल बनाएं।",
    "archaeology.level2.story.realWorldContext":
        "सुरक्षा ऑडिट, कोड रिव्यू, और जटिल प्रोजेक्ट इतिहास को समझने के लिए एडवांस्ड Git log तकनीकें ज़रूरी हैं।",
    ...
    "archaeology.level3.story.narrative":
        "शुक्रवार शाम 4:30 बजे हैं। आपके साथी Jake घबरा जाते हैं: 'मैंने गलती से git reset --hard चला दिया और दो हफ़्तों का काम खो दिया! ऑथेंटिकेशन सिस्टम, UI कंपोनेंट्स, टेस्ट - सब कुछ चला गया!' लेकिन आपको याद है: Git कभी कुछ नहीं भूलता। Git reflog हर कमिट, ब्रांच स्विच, मर्ज, और रीसेट को ट्रैक करता है। यहां तक कि 'डिलीट' हुए कमिट भी 90 दिनों तक reflog में मौजूद रहते हैं। आपका मिशन: `git reflog` चलाएं, खोए हुए कमिट खोजें, और `git reset --hard` तथा एक रिकवरी ब्रांच से Jake का काम वापस लाएं। हीरो बनने का समय आ गया है!",
    "archaeology.level3.story.realWorldContext":
        "Git reflog एक शक्तिशाली रिकवरी टूल है जो डेवलपरों को भयंकर डेटा लॉस से बचा सकता है।",
    "archaeology.level3.story.taskIntroduction":
        "Git reflog में महारत हासिल करें और वह हीरो बनें जो 'खोए हुए' काम को वापस ला सके और अपने साथियों का दिन बचा सके।",
