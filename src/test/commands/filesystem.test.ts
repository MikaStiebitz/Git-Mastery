...
describe("Filesystem Commands", () => {
    ...
    describe("MkdirCommand", () => {
        it("should create a directory", () => {
            ...
            const output = mkdirCmd.execute({ args: ["newdir"], flags: {}, positionalArgs: ["newdir"] }, context);
        ...
        it("should handle absolute paths", () => {
            const mkdirCmd = new MkdirCommand();
            mkdirCmd.execute({ args: ["/test"], flags: {}, positionalArgs: ["/test"] }, context);
    ...
    describe("TouchCommand", () => {
        ...
        it("should handle relative paths", () => {
            ...
            const touchCmd = new TouchCommand();
            touchCmd.execute({ args: ["test.txt"], flags: {}, positionalArgs: ["test.txt"] }, context);
    ...
    describe("CatCommand", () => {
        ...
        it("should fail on directory", () => {
            const catCmd = new CatCommand();
            const output = catCmd.execute({ args: ["/home"], flags: {}, positionalArgs: ["/home"] }, context);
        ...
        it("should handle relative paths", () => {
            ...
            const catCmd = new CatCommand();
            const output = catCmd.execute({ args: ["file.txt"], flags: {}, positionalArgs: ["file.txt"] }, context);
    ...
    describe("RmCommand", () => {
        ...
        it("should fail to remove directory without -r", () => {
            const rmCmd = new RmCommand();
            const output = rmCmd.execute({ args: ["/home"], flags: {}, positionalArgs: ["/home"] }, context);
