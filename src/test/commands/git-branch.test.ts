...
describe("Git Branch Commands", () => {
    ...
    describe("BranchCommand", () => {
        ...
        it("should create a new branch", () => {
            const branchCmd = new BranchCommand();
            const output = branchCmd.execute({ args: ["feature"], flags: {}, positionalArgs: ["feature"] }, context);
        ...
        it("should not delete current branch", () => {
            ...
            // Real Git: "error: cannot delete branch 'main' used by worktree at '<path>'"
            expect(output[0]).toContain("cannot delete branch");
        });
    ...
    describe("CheckoutCommand", () => {
        ...
        it("should switch to existing branch", () => {
            ...
            const output = checkoutCmd.execute({ args: ["feature"], flags: {}, positionalArgs: ["feature"] }, context);
        ...
        it("should handle already on branch message", () => {
            const checkoutCmd = new CheckoutCommand();
            const output = checkoutCmd.execute({ args: ["main"], flags: {}, positionalArgs: ["main"] }, context);
        ...
        it("should require git initialization", () => {
            const newContext = createTestContext();
            const checkoutCmd = new CheckoutCommand();
            const output = checkoutCmd.execute({ args: ["main"], flags: {}, positionalArgs: ["main"] }, newContext);
    ...
    describe("SwitchCommand", () => {
        ...
        it("should switch to existing branch", () => {
            ...
            const output = switchCmd.execute({ args: ["feature"], flags: {}, positionalArgs: ["feature"] }, context);
        ...
        it("should provide helpful suggestions for similar branch names", () => {
            ...
            const switchCmd = new SwitchCommand();
            const output = switchCmd.execute({ args: ["feat"], flags: {}, positionalArgs: ["feat"] }, context);
    ...
    describe("MergeCommand", () => {
        ...
        it("should merge branch into current branch", () => {
            ...
            const output = mergeCmd.execute({ args: ["feature"], flags: {}, positionalArgs: ["feature"] }, context);
        ...
        it("should not merge into self", () => {
            const mergeCmd = new MergeCommand();
            const output = mergeCmd.execute({ args: ["main"], flags: {}, positionalArgs: ["main"] }, context);
        ...
        it("should require git initialization", () => {
            const newContext = createTestContext();
            const mergeCmd = new MergeCommand();
            const output = mergeCmd.execute({ args: ["feature"], flags: {}, positionalArgs: ["feature"] }, newContext);
