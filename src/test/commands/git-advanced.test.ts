...
describe("Git Advanced Commands", () => {
    ...
    describe("StashCommand", () => {
        ...
        it("should list stashes", () => {
            ...
            const output = stashCmd.execute({ args: ["list"], flags: {}, positionalArgs: ["list"] }, context);
        ...
        it("should pop stash", () => {
            ...
            const output = stashCmd.execute({ args: ["pop"], flags: {}, positionalArgs: ["pop"] }, context);
    ...
    describe("TagCommand", () => {
        ...
        it("should create a tag", () => {
            ...
            const output = tagCmd.execute({ args: ["v1.0.0"], flags: {}, positionalArgs: ["v1.0.0"] }, context);
    ...
    describe("BisectCommand", () => {
        ...
        it("should start bisect", () => {
            ...
            const output = bisectCmd.execute({ args: ["start"], flags: {}, positionalArgs: ["start"] }, context);
        ...
        it("should mark commit as bad", () => {
            ...
            const output = bisectCmd.execute({ args: ["bad"], flags: {}, positionalArgs: ["bad"] }, context);
        ...
        it("should reset bisect", () => {
            ...
            const output = bisectCmd.execute({ args: ["reset"], flags: {}, positionalArgs: ["reset"] }, context);
