...
describe("Git Remote Commands", () => {
    ...
    describe("RemoteCommand", () => {
        ...
        it("should add a remote", () => {
            ...
            const output = remoteCmd.execute(
                {
                    args: ["add", "upstream", "https://github.com/user/repo.git"],
                    flags: {},
                    positionalArgs: ["add", "upstream", "https://github.com/user/repo.git"],
                },
                context,
            );
        ...
        it("should show remote URL with -v flag", () => {
            const remoteCmd = new RemoteCommand();
            const output = remoteCmd.execute({ args: ["-v"], flags: { v: true }, positionalArgs: [] }, context);
        ...
        it("should remove a remote", () => {
            ...
            const remoteCmd = new RemoteCommand();
            remoteCmd.execute({ args: ["remove", "test"], flags: {}, positionalArgs: ["remove", "test"] }, context);
        ...
        it("should not add duplicate remotes", () => {
            ...
            const output = remoteCmd.execute(
                {
                    args: ["add", "origin", "https://github.com/other/repo.git"],
                    flags: {},
                    positionalArgs: ["add", "origin", "https://github.com/other/repo.git"],
                },
                context,
            );
    ...
    describe("PushCommand", () => {
        ...
        it("should fail if remote does not exist", () => {
            ...
            // Real Git treats an unknown remote name as a URL it cannot reach.
            expect(output[0]).toContain("does not appear to be a git repository");
        });
    ...
    describe("CloneCommand", () => {
            ...
            const output = cloneCmd.execute(
                {
                    ...
                    flags: {},
                    positionalArgs: ["https://github.com/user/repo.git"],
                },
                context,
            );
        ...
        it("should create directory with repo name", () => {
            ...
            cloneCmd.execute(
                {
                    args: ["https://github.com/user/my-project.git"],
                    flags: {},
                    positionalArgs: ["https://github.com/user/my-project.git"],
                },
                context,
            );
        ...
        it("should handle different URL formats", () => {
            ...
            cloneCmd.execute(
                {
                    args: ["https://github.com/user/repo1.git"],
                    flags: {},
                    positionalArgs: ["https://github.com/user/repo1.git"],
                },
                context,
            );
            ...
            cloneCmd.execute(
                {
                    args: ["git@github.com:user/repo2.git"],
                    flags: {},
                    positionalArgs: ["git@github.com:user/repo2.git"],
                },
                context,
            );
        ...
        it("should require a URL argument", () => {
            const cloneCmd = new CloneCommand();
            const output = cloneCmd.execute({ args: [], flags: {}, positionalArgs: [] }, context);
